...
public class RentSeriesPane {
    ...
    public void setUp()
    {
        List<Movie> movieList = ClientStart.getAcc().rentTVseries;
        if(movieList.isEmpty())
        {
            ...
            Title.setText("No rented series");
        ...
        {
            Description.setText(ClientStart.getAcc().rentTVseries.get(current).description);
            Director.setText(ClientStart.getAcc().rentTVseries.get(current).director);
            Genre.setText(ClientStart.getAcc().rentTVseries.get(current).genre);
            Year.setText(String.valueOf(ClientStart.getAcc().rentTVseries.get(current).year));
            Title.setText(ClientStart.getAcc().rentTVseries.get(current).title);
            showPhoto(ClientStart.getAcc().rentTVseries.get(current).id);
        }
    }
    public RentSeriesPane()
    {
        setUp();
    }
    @FXML
    ...
    {
        ClientStart.getAcc().rentTVseries.remove(current);
        current = 0;
        setUp();
    }
    ...
    {
        if(current < ClientStart.getAcc().rentTVseries.size()-1)
            current++;
        setUp();
    }
    @FXML
