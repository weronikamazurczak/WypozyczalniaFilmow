...
public class FavouritesMoviesPanel {
    ...
    public void setUp()
    {
        List<Movie> movieList = ClientStart.getAcc().favouriteMovies;
        ...
        {
            Description.setText(ClientStart.getAcc().favouriteMovies.get(current).description);
            Director.setText(ClientStart.getAcc().favouriteMovies.get(current).director);
            Genre.setText(ClientStart.getAcc().favouriteMovies.get(current).genre);
            Year.setText(String.valueOf(ClientStart.getAcc().favouriteMovies.get(current).year));
            Title.setText(ClientStart.getAcc().favouriteMovies.get(current).title);
            showPhoto(ClientStart.getAcc().favouriteMovies.get(current).id);
        }
    }
    public FavouritesMoviesPanel()
    {
        setUp();
    }
    @FXML
    ...
    {
        ClientStart.getAcc().favouriteMovies.remove(current);
        current = 0;
        setUp();
    }
    ...
    {
        if(current < ClientStart.getAcc().favouriteMovies.size()-1)
            current++;
        setUp();
    }
    @FXML
